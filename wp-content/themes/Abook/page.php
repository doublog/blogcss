			...
			<div id="mybook">
				...
				<?php if(have_posts()) : while(have_posts()): the_post(); ?>
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="postmeta">
		<span class="data"><?php time_diff( $time_type = 'post' ); ?></span><span class="view"><?php if(function_exists('the_views')) { the_views(); }elseif(function_exists('post_views')){post_views('点击', '次');} ?></span><span class="com_num"><?php comments_popup_link('0条评论', '1条评论', '%条评论'); ?></span>
	</div>
