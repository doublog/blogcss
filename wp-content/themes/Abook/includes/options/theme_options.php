...
//功能模块设置
	...
	array("name" => "文章链接和分享",
	 ...
	 array("name" => "文章底部插入内容",
            ...
            "type" => "textarea",
            "std" => "<strong>声明:</strong> 本文采用 <a href=\"http://creativecommons.org/licenses/by-nc-sa/3.0/\" rel=\"nofollow external\"><abbr title=\"署名-非商业性使用-相同方式共享\">BY-NC-SA</abbr></a> 协议进行授权. 转载请注明 "),
	array(  "name" => "特殊英文字体支持",
	...
	array(  "name" => "外部相册支持",
			"desc" => "新建一个模板为gallery的页面，可以嵌入外部网页作为相册，例如flash等。（注意：iframe框架高度和宽度将限制在380px，多余部分隐藏）",
            "id" => $shortname."_gallery",
            "type" => "text",
            "std" => "http://pic.winysky.com"),
	array(  "name" => "无觅插件支持",
...
<p>友情提示：本主题由<a href="http://winysky.com" target="_blank">Winy</a>设计,售后支持:admin@winysky.com</p>
...
<div class="rm_section" style="padding:5px">
	...
	<P>写文章时可以加入下列短代码（可视化与HTML两种模式均可直接加入）</p>
		...
		<h4>音乐播放器</h4>
		<p>默认不自动播放：　<code>[music]http://www.xxx.com/xxx.mp3[/music]</code></p>
		<p>自动播放：　<code>[music auto=1]http://www.xxx.com/xxx.mp3[/music]</code></p>
	  ...
	  <h4>下载样式</h4>
      <p><code>[Downlink href="http://www.xxx.com/xxx.zip"]download xxx.zip[/Downlink]</code></p>


      <h4>Flv播放器</h4>
      <p>注意：如果要使用这个播放器，一定要添加flv格式的视频文件</p>
      <p>默认不自动播放：　<code>[flv]http://www.xxx.com/xxx.flv[/flv]</code></p>
      <p>自动播放：　<code>[flv auto="1"]http://www.xxx.com/xxx.flv[/flv]</code></p>
