<?php get_header(); ?>
		<div id="main">
			...
			<div id="mybook">
				...
				<div class="catname" style="display:none;"><?php echo $query_string;?></div>
				<?php 
				if($i%2==0){
					if($j%2!=0){
				...
				<!-- #post-## -->
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						<h2 ><a  href="<?php the_permalink() ?>" rel="bookmark" title="查看文章: <?php the_title_attribute(); ?>"><?php if (is_sticky()) {echo "[置顶]";} ?><?php winyexcerpt(25, '...', 'title');?></a><span class="com_num"><?php comments_popup_link('来抢沙发', '1条评论', '%条评论'); ?></span></h2>
						<div class="postmeta">
