...
$('.entry img').each(function() {
    var maxWidth,maxHeight;    // 图片最大高宽
		...
		maxWidth = 460;maxHeight = 560; 
	}else{
		maxWidth = 360;maxHeight = 560; 
	}
    var ratio = 0;  // 缩放比例
...
$("#nav li").hover(function() {
	...
	$('#cup').hover(function(){ $('#s').show().focus();$('#searchsubmit').fadeIn();}, function() {$('#s,#searchsubmit').hide()});
