...
<div class="scrollbar"><div class="track"><div class="thumb"><div class="end"></div></div></div></div>
	<div class="viewport">
		<div class="overview">
<p><iframe src="<?php if (get_option('Abook_gallery')!="") { echo get_option('Abook_gallery');} ?>" width="380" height="380" frameborder="0" scrolling="no"></iframe></p>
</div>
</div>
</div>
<div class="clear"></div>
...
<div class="pagecontent single-right">
 ...
 <?php echo '</div></div></div>';get_footer(); ?>
