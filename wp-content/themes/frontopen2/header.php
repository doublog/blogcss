...
<meta name="description" content="豆博|豆子的私人博客，好记性不如烂笔头" />
...
<!--<div class="nav marauto">
        ...
        <?php if(get_option('themes_fo2_top_right_btn_text')){?>
            ...
            <a href="<?php bloginfo('rss2_url');?>" rel="alternate" type="application/rss+xml" target="_blank" title="rss Feed"><span class="rrs">订阅RSS</span></a>
            <?php }?>
        </div>
        <div class="navlist">
