...
class u142_index_cms5 extends WP_Widget {

	function u142_index_cms5(){

		$widget_ops = array('description' => '首页CMS栏目五');

		parent::WP_Widget('u142_index_cms5',$name='u142-首页CMS栏目五',$widget_ops);
	...
	function index_cms5_posts($args = ''){
		...
		$cms5_fenlei=explode(",",$cat);		
		
?>
		
			<?php for($i=0;$i<2;$i++) { ?>

			<div class="psy_part" <?php if($i==0) { ?>id="id_touxiang_part"<?php }elseif($i==1){ ?>id="id_shipin_part"<?php } ?>>
				<div class="psy_title">
					<span class="fgreen"><a href="<?php echo get_category_link($cms5_fenlei[$i]); ?>"><?php echo get_cat_name($cms5_fenlei[$i]); ?></a></span>
					<div class="roll">
...
//激活小工具
register_widget('u142_index_cms5');
?>