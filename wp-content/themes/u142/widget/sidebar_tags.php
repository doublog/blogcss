...
class u142_sidebar_tags extends WP_Widget {

	function u142_sidebar_tags(){

		$widget_ops = array('description' => 'u142-边栏标签');

		parent::WP_Widget('u142_sidebar_tags',$name='u142-边栏标签',$widget_ops);
	...
	function form($instance){
		...
		echo '<p style="text-align:left;"><label for="'.$this->get_field_name('all_tags_url').'">“View All Tags »” 的链接:<input style="width:200px;" id="'.$this->get_field_id('all_tags_url').'" name="'.$this->get_field_name('all_tags_url').'" type="text" value="'.$all_tags_url.'" /></label></p>';
...
?>		
	...
	<div class="tagcloud">
		<?php wp_tag_cloud('smallest=9&largest=16&exclude='.$tags_id); ?>
	</div>
	<div class="action">
		<a class="view-more" href="<?php echo $all_tags_url; ?>">View All Tags »</a>
	</div>
...
//小工具在前台显示效果
	...
	function widget($args, $instance){
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('边栏标签','u142') : $instance['title']);//小工具前台标题
...
//激活小工具
register_widget('u142_sidebar_tags');
?>